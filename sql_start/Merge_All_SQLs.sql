...
ALTER TABLE `accounts` CHANGE `password` `password` VARCHAR(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL;
ALTER TABLE `characters` ADD COLUMN `barrackLayer` INT NOT NULL DEFAULT 1;CREATE TABLE IF NOT EXISTS `chatmacros` (
...
ALTER TABLE `accounts` ADD `medals` INT NOT NULL DEFAULT 0;
ALTER TABLE `accounts` ADD `giftMedals` INT NOT NULL DEFAULT 0;
ALTER TABLE `accounts` ADD `premiumMedals` INT NOT NULL DEFAULT 0;
...
ALTER TABLE `characters` ADD `hpRate` FLOAT NOT NULL DEFAULT '1' AFTER `hp`, 
                         ...
                         CHANGE `dex` `dex` INT NOT NULL DEFAULT '0';ALTER TABLE `characters` CHANGE `hair` `hair` INT NOT NULL;
...
ALTER TABLE `accounts` CHANGE `settings` `settings` VARCHAR(2048) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '';
...
ALTER TABLE `accounts` ADD `barracksThema` INT NOT NULL DEFAULT '11' AFTER `teamExp`;
