...
namespace Melia.Channel.World
{
	public class Character : IEntity, ICommander, IPropertyObject
	{
		...
		public void SendPCProperties()
		{
			...
			pcProps.Set(PropertyId.PC.CRTATK, 13.000000f);
			...
			pcProps.Set(PropertyId.PC.MNA, 3.000000f);
			...
			pcProps.Set(PropertyId.PC.STR, 7.000000f);
			...
			pcProps.Set(PropertyId.PC.MAXPATK_SUB, 35.000000f);
			...
			pcProps.Set(PropertyId.PC.DEX, 6.000000f);
			...
			pcProps.Set(PropertyId.PC.SR, 4.000000f);
			...
			pcProps.Set(PropertyId.PC.CRTMATK, 7.000000f);
			...
			pcProps.Set(PropertyId.PC.MINPATK, 71.000000f);
			...
			pcProps.Set(PropertyId.PC.MHP, 408.000000f);
			...
			pcProps.Set(PropertyId.PC.MINMATK, 25.000000f);
			...
			pcProps.Set(PropertyId.PC.MAXMATK, 25.000000f);
			...
			pcProps.Set(PropertyId.PC.MAXPATK, 73.000000f);
			pcProps.Set(PropertyId.PC.Slash_Atk, 0.000000f);
			pcProps.Set(PropertyId.PC.INT, 2.000000f);
			pcProps.Set(PropertyId.PC.RHP, 4.000000f);
			pcProps.Set(PropertyId.PC.MINPATK_SUB, 35.000000f);
			pcProps.Set(PropertyId.PC.Sta_Step, 2500.000000f);
			pcProps.Set(PropertyId.PC.CON, 7.000000f);
			...
			pcProps.Set(PropertyId.PC.DEF, 88.000000f);
