...
namespace Melia.Zone.Buffs.Handlers.Clerics.Sadhu
{
	...
	public class OOBE_Tanoti_Buff : Sadhu_BuffHandler_Base
	{
		...
		public override void OnEnd(Buff buff)
		{
			...
			if (!characterSkillHandling.TryGetSkill(SkillId.Sadhu_Tanoti, out var skill))
				return;

			characterSkillHandling.SetAttackState(true);

			// Creates the Area Of Effect for that will pulling enemies inside the area for the center.
