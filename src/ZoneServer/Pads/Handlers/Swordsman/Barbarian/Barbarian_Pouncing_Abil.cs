...
namespace Melia.Zone.Pads.Handlers.Swordsman.Barbarian
{
	...
	public class Barbarian_Pouncing_Abil : ICreatePadHandler, IDestroyPadHandler, IUpdatePadHandler
	{
		...
		public void Created(object sender, PadTriggerArgs args)
		{
			...
			Send.ZC_NORMAL.PadUpdate(creator, pad, PadName.Barbarian_Pouncing_Abil, 0, 0, 150, true);
		}
		...
		public void Destroyed(object sender, PadTriggerArgs args)
		{
			...
			Send.ZC_NORMAL.PadUpdate(creator, pad, PadName.Barbarian_Pouncing_Abil, 0, 0, 150, false);
		}
