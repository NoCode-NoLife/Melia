...
namespace Melia.Zone.Skills.Handlers.Monsters
{
	...
	public class Mon_boss_bebraspion_Skill_4 : ParametersOnlySkill
	{
		protected override TimeSpan DamageDelay { get; } = TimeSpan.FromMilliseconds(10199);
		protected override TimeSpan HitDelay { get; } = TimeSpan.FromMilliseconds(9999);
		protected override SplashType SplashType { get; } = SplashType.Fan;
	...
	public class Mon_boss_varleking_Skill_2 : ParametersOnlySkill
	{
		protected override TimeSpan DamageDelay { get; } = TimeSpan.FromMilliseconds(10199);
		protected override TimeSpan HitDelay { get; } = TimeSpan.FromMilliseconds(9999);
		protected override SplashType SplashType { get; } = SplashType.Fan;
	...
	[SkillHandler(SkillId.Mon_d_uniq_raid_boss_froster_lord_Skill_3, SkillId.Mon_weekly_boss_froster_lord_Skill_3, SkillId.Mon_field_boss_froster_lord_Skill_3, SkillId.Mon_FD_boss_froster_lord_Skill_2)]
	public class Mon_d_uniq_raid_boss_froster_lord_Skill_3 : ParametersOnlySkill
	{
		protected override TimeSpan DamageDelay { get; } = TimeSpan.FromMilliseconds(10199);
		protected override TimeSpan HitDelay { get; } = TimeSpan.FromMilliseconds(9999);
		protected override SplashType SplashType { get; } = SplashType.Fan;
	...
	public class Mon_weekly_boss_Naktis_Skill_2 : ParametersOnlySkill
	{
		protected override TimeSpan DamageDelay { get; } = TimeSpan.FromMilliseconds(10199);
		protected override TimeSpan HitDelay { get; } = TimeSpan.FromMilliseconds(9999);
		protected override SplashType SplashType { get; } = SplashType.Fan;
