...
namespace Melia.Zone.Skills.Handlers.Highlander
{
	...
	public class Crown : IGroundSkillHandler
	{
		/// <summary>
		...
		private async void Attack(Skill skill, ICombatEntity caster, ISplashArea splashArea)
		{
			...
			// for Crown is 200, the packets look more like a 50~100ms
			...
			{
				target.StartBuff(BuffId.Crown_Buff, skill.Level, 0, TimeSpan.FromSeconds(10), caster);
