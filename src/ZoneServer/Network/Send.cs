...
namespace Melia.Zone.Network
{
	public static class Send
	{
		...
		public static void ZC_NORMAL_BarrackSlotCount(IZoneConnection conn, int count)
		{
		...
		/// <param name="target"></param>
		/// <param name="position"></param>
		public static void ZC_NORMAL_Skill_16(Character character, IActor target, Position position)
		{
			var packet = new Packet(Op.ZC_NORMAL);
		...
		/// </summary>
		/// <param name="conn"></param>
		public static void ZC_NORMAL_AdventureBook(IZoneConnection conn)
		{
			var packet = new Packet(Op.ZC_NORMAL);
		...
		/// </summary>
		/// <param name="conn"></param>
		public static void ZC_NORMAL_SetSessionKey(IZoneConnection conn)
		{
			var packet = new Packet(Op.ZC_NORMAL);
		...
		/// <param name="monster"></param>
		/// <param name="duration"></param>
		public static void ZC_NORMAL_FadeOut(IMonster monster, TimeSpan duration)
		{
			var packet = new Packet(Op.ZC_NORMAL);
		...
		public static void ZC_NORMAL_ItemDrop(IMonster monster, Direction direction, float distance)
		{
