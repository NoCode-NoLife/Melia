...
namespace Melia.Shared.Network
{
	...
	public static class Op
	{
		...
		public const int BC_COMMANDER_CREATE = 0x19; // Size: 610
		...
		public const int ZC_ENTER_DUMMYPC = 0xC1F; // Size: 568
		public const int ZC_UPDATED_DUMMYPC = 0xC20; // Size: 526
		...
		public const int ZC_UPDATED_PCAPPEARANCE = 0xC32; // Size: 526
		...
		public const int ZC_SHOW_LOCAL_MAP = 0xD5A; // Size: 0
		public const int CZ_FLEE_OBSTACLE = 0xD5B; // Size: 38
		...
		public const int ZC_GROUND_EFFECT = 0xD5F; // Size: 56
		...
		public const int ZC_UPDATE_SHIELD = 0xD64; // Size: 23
		public const int ZC_SHOW_MODEL = 0xD65; // Size: 19
		public const int ZC_SHOW_SCENE_MODEL = 0xD66; // Size: 15
		public const int ZC_SKILL_RANGE_DBG = 0xD67; // Size: 74
		public const int ZC_SKILL_RANGE_FAN = 0xD68; // Size: 50
		public const int ZC_SKILL_RANGE_SQUARE = 0xD69; // Size: 52
		public const int ZC_SKILL_RANGE_CIRCLE = 0xD6A; // Size: 40
		public const int ZC_POS_DBG = 0xD6B; // Size: 38
		...
		public const int ZC_ADDITIONAL_SKILL_POINT = 0xD75; // Size: 0
		public const int ZC_MON_STAMINA = 0xD76; // Size: 26
		public const int CZ_CUSTOM_SCP = 0xD77; // Size: 26
		public const int ZC_VIEW_FOCUS = 0xD78; // Size: 29
		public const int ZC_HARDCODED_SKILL = 0xD79; // Size: 30
		public const int CZ_HARDCODED_SKILL = 0xD7A; // Size: 46
		...
		public const int CZ_HARDCODED_ITEM = 0xD7F; // Size: 34
		public const int CZ_CANCEL_TRANSFORM_SKILL = 0xD80; // Size: 22
		public const int CZ_BRIQUET = 0xD81; // Size: 0
		public const int ZC_VIBRATE = 0xD82; // Size: 34
		public const int ZC_COUNTER_MOVE = 0xD83; // Size: 14
		public const int CZ_COUNTER_ATTACK = 0xD84; // Size: 26
		public const int CZ_CLIENT_DIRECT = 0xD85; // Size: 42
		...
		public const int CZ_RUN_BGEVENT = 0xD89; // Size: 86
		public const int ZC_ADD_SKILL_EFFECT = 0xD8A; // Size: 22
		public const int ZC_ITEM_DROPABLE = 0xD8B; // Size: 14
		public const int CZ_ITEM_DROP_TO_OBJECT = 0xD8C; // Size: 38
		public const int ZC_NORMAL = 0xD8D; // Size: 0
		public const int CZ_G_QUEST_CHECK = 0xD8E; // Size: 26
		public const int ZC_MOVE_PATH_MATH = 0xD8F; // Size: 38
		public const int CZ_MYPAGE_COMMENT_ADD = 0xD90; // Size: 290
		public const int CZ_MYPAGE_COMMENT_DELETE = 0xD91; // Size: 30
		public const int CZ_GUESTPAGE_COMMENT_ADD = 0xD92; // Size: 290
		public const int CZ_GET_TARGET_MYPAGE = 0xD93; // Size: 26
		public const int CZ_ON_MYPAGE_MODE = 0xD94; // Size: 26
		public const int CZ_RESET_SOCIAL_MODE = 0xD95; // Size: 22
		public const int CZ_GET_TARGET_GUESTPAGE = 0xD96; // Size: 26
		public const int CZ_ADD_SELLMODE_ITEM = 0xD97; // Size: 42
		public const int CZ_DELETE_SELLMODE_ITEM = 0xD98; // Size: 30
		public const int CZ_ON_SELLITEM_MODE = 0xD99; // Size: 26
		...
		public const int CZ_HELP_READ_TYPE = 0xDA6; // Size: 30
		public const int CZ_MOVE_PATH_END = 0xDA7; // Size: 22
		public const int ZC_COLL_DAMAGE = 0xDA8; // Size: 15
		public const int CZ_KEYBOARD_BEAT = 0xDA9; // Size: 22
		public const int CZ_MOVEHIT_SCP = 0xDAA; // Size: 34
		...
		public const int CZ_STOP_TIMEACTION = 0xDAF; // Size: 23
		public const int CZ_REQ_DUMMYPC_INFO = 0xDB0; // Size: 30
		public const int CZ_VISIT_BARRACK = 0xDB1; // Size: 86
		public const int CZ_SPC_SKILL_POS = 0xDB2; // Size: 34
		public const int CZ_CHANGE_HEAD = 0xDB3; // Size: 86
		public const int CZ_CHANGE_DESIGNCUT = 0xDB4; // Size: 86
		public const int CZ_CREATE_ARROW_CRAFT = 0xDB5; // Size: 26
		public const int CZ_EXCHANGE_ANTIQUE = 0xDB6; // Size: 34
		public const int CZ_EXCHANGE_WEAPONTYPE = 0xDB7; // Size: 34
		public const int CZ_REQ_MINITEXT = 0xDB8; // Size: 278
		public const int ZC_PC_MOVE_STOP = 0xDB9; // Size: 63
		public const int CZ_STOP_ALLPC = 0xDBA; // Size: 22
		public const int CZ_COMPLETE_PRELOAD = 0xDBB; // Size: 26
		public const int CZ_MGAME_JOIN_CMD = 0xDBC; // Size: 58
		public const int CZ_ADD_HELP = 0xDBD; // Size: 26
		public const int ZC_ATTACH_TO_OBJ = 0xDBE; // Size: 53
		public const int ZC_DETACH_FROM_OBJ = 0xDBF; // Size: 18
		public const int ZC_RUN_FROM = 0xDC0; // Size: 18
		public const int ZC_LOOKAT_OBJ = 0xDC1; // Size: 18
		public const int CZ_SKILL_CELL_LIST = 0xDC2; // Size: 0
		public const int CZ_SKILL_TOOL_GROUND_POS = 0xDC3; // Size: 39
		public const int CZ_DIRECTION_PROCESS = 0xDC4; // Size: 34
		public const int CZ_DIRECTION_MOVE_STATE = 0xDC5; // Size: 0
		public const int ZC_TO_ALL_CLIENT = 0xDC6; // Size: 0
		public const int ZC_TO_CLIENT = 0xDC7; // Size: 0
		public const int CZ_REWARD_CMD = 0xDC8; // Size: 26
		public const int CZ_PROPERTY_COMPARE = 0xDC9; // Size: 28
		public const int ZC_PROPERTY_COMPARE = 0xDCA; // Size: 0
		public const int ZC_PROPERTY_COMPARE_FOR_ACT = 0xDCB; // Size: 0
		public const int ZC_PROPERTY_COMPARE_FOR_REP_CLASS = 0xDCC; // Size: 0
		public const int ZC_FACTION = 0xDCD; // Size: 18
		public const int ZC_SEND_CASH_VALUE = 0xDCE; // Size: 0
		public const int ZC_BEGIN_KILL_LOG = 0xDCF; // Size: 10
		public const int ZC_END_KILL_LOG = 0xDD0; // Size: 10
		public const int ZC_CLEAR_KILL_LOG = 0xDD1; // Size: 10
		public const int CZ_NPC_AUCTION_CMD = 0xDD2; // Size: 42
		public const int ZC_DIRECTION_APC = 0xDD3; // Size: 30
		public const int ZC_BGMODEL_ANIM_INFO = 0xDD4; // Size: 19
		public const int ZC_ATTACH_BY_KNOCKBACK = 0xDD5; // Size: 42
		public const int CZ_OBJECT_MOVE = 0xDD6; // Size: 39
		public const int CZ_CONTROL_OBJECT_ROTATE = 0xDD7; // Size: 34
		public const int CZ_SUMMON_COMMAND = 0xDD8; // Size: 30
		public const int CZ_VEHICLE_RIDE = 0xDD9; // Size: 27
		public const int CZ_REQ_ACHIEVE_RANK_PAGE_INFO = 0xDDA; // Size: 90
		public const int ZC_SPC_TRIGGER_EXEC = 0xDDB; // Size: 34
		public const int CZ_REQ_MGAME_VIEW = 0xDDC; // Size: 30
		public const int CZ_REQ_MGAME_CHAT = 0xDDD; // Size: 0
		public const int CZ_TOURNAMENT_GIFT = 0xDDE; // Size: 30
		public const int CZ_PARTY_INVITE_ACCEPT = 0xDDF; // Size: 99
		public const int CZ_PARTY_INVITE_CANCEL = 0xDE0; // Size: 103
		public const int CZ_PARTY_PROP_CHANGE = 0xDE1; // Size: 159
		public const int CZ_REQ_MARKET_REGISTER = 0xDE2; // Size: 70
		public const int CZ_REQ_MARKET_MINMAX_INFO = 0xDE3; // Size: 30
		public const int CZ_REQ_MARKET_BUY = 0xDE4; // Size: 0
		public const int CZ_REQ_CABINET_LIST = 0xDE5; // Size: 22
		public const int CZ_REQ_GET_CABINET_ITEM = 0xDE6; // Size: 42
		public const int CZ_REQ_CANCEL_MARKET_ITEM = 0xDE7; // Size: 30
		public const int CZ_INV_ITEM_LOCK = 0xDE8; // Size: 31
		public const int CZ_OBJ_RECORD_POS = 0xDE9; // Size: 0
		public const int CZ_FORMATION_CMD = 0xDEA; // Size: 44
		public const int CZ_REGISTER_AUTOSELLER = 0xDEB; // Size: 0
		public const int CZ_OPEN_AUTOSELLER = 0xDEC; // Size: 94
		public const int CZ_BUY_AUTOSELLER_ITEMS = 0xDED; // Size: 0
		public const int CZ_SELL_MY_AUTOSELLER_ITEMS = 0xDEE; // Size: 0
		public const int CZ_PUZZLE_CRAFT = 0xDEF; // Size: 0
		public const int CZ_PET_EQUIP = 0xDF0; // Size: 46
		public const int CZ_PET_AUTO_ATK = 0xDF1; // Size: 23
		public const int ZC_PET_AUTO_ATK = 0xDF2; // Size: 23
		public const int ZC_TO_SOMEWHERE_CLIENT = 0xDF3; // Size: 0
		public const int CZ_REVEAL_NPC_STATE = 0xDF4; // Size: 26
		public const int CZ_CHANGE_CHANNEL = 0xDF5; // Size: 24
		public const int CZ_REQ_CHANNEL_TRAFFICS = 0xDF6; // Size: 24
		public const int CZ_BUY_PROPERTYSHOP_ITEM = 0xDF7; // Size: 0
		public const int CZ_SKILL_USE_HEIGHT = 0xDF8; // Size: 26
		public const int CZ_CHANGE_GUILD_NEUTRALITY = 0xDF9; // Size: 22
		public const int CZ_SAVE_GUILD_BOARD = 0xDFA; // Size: 122
		public const int CZ_DELETE_PARTY_EVENT = 0xDFB; // Size: 32
		public const int CZ_PING = 0xDFC; // Size: 22
		public const int ZC_PING = 0xDFD; // Size: 22
		public const int CZ_REQ_REMAIN_NEXONCASH = 0xDFE; // Size: 22
		public const int CZ_REQ_OPEN_INGAMESHOP_UI = 0xDFF; // Size: 22
		public const int CZ_REQ_BUY_INGAMESHOP_ITEM = 0xE00; // Size: 90
		public const int CZ_REQ_BUY_ALL_INGAMESHOP_ITEM = 0xE01; // Size: 22
		public const int CZ_REQ_PICKUP_CASHITEM = 0xE02; // Size: 49
		public const int CZ_REQ_REFUND_CASHITEM = 0xE03; // Size: 45
		public const int ZC_XIGNCODE_BUFFER = 0xE04; // Size: 536
		public const int CZ_XIGNCODE_BUFFER = 0xE05; // Size: 536
		public const int CZ_SYSTEM_LOG_SAVE_TO_MONGODB = 0xE06; // Size: 292
		public const int CZ_CHANGE_TITLE = 0xE07; // Size: 86
		public const int CZ_PC_COMMENT_CHANGE = 0xE08; // Size: 0
		public const int CZ_AUTTOSELLER_BUYER_CLOSE = 0xE09; // Size: 30
		public const int CZ_REQ_ITEM_LIST = 0xE0A; // Size: 23
		public const int CZ_REQ_ACC_WARE_VIS_LOG = 0xE0B; // Size: 22
		public const int CZ_HIT_MISSILE = 0xE0C; // Size: 26
		public const int CZ_PARTY_JOIN_BY_LINK = 0xE0D; // Size: 39
		public const int CZ_PVP_ZONE_CMD = 0xE0E; // Size: 39
		public const int CZ_PVP_CHAT = 0xE0F; // Size: 0
		public const int CZ_CARDBATTLE_CMD = 0xE10; // Size: 38
		public const int CZ_REQ_UPDATE_CONTENTS_SESSION = 0xE11; // Size: 22
		public const int CZ_REQ_FRIENDLY_FIGHT = 0xE12; // Size: 27
		public const int CZ_REQ_ANCIENT_FRIENDLY_FIGHT = 0xE13; // Size: 27
		public const int CZ_HARDSKILL_POS_LIST = 0xE14; // Size: 0
		public const int CZ_CART_POSITION = 0xE15; // Size: 38
		public const int CZ_REQ_RIDE_CART = 0xE16; // Size: 30
		public const int CZ_DUMMYPC_SKILL_POS = 0xE17; // Size: 38
		public const int CZ_NGS = 0xE18; // Size: 0
		public const int ZC_NGS = 0xE19; // Size: 0
		public const int CZ_PARTY_MEMBER_SKILL_USE = 0xE1A; // Size: 0
		public const int CZ_PARTY_MEMBER_SKILL_ACCEPT = 0xE1B; // Size: 35
		public const int CZ_SYSTEM_LOG_TO_SERVER = 0xE1C; // Size: 1111
		...
		public const int CZ_REQ_PILGRIM_ENTER = 0x1000; // Size: 26
		public const int CZ_REQ_LEVEL_DUNGEON_ENTER = 0x1001; // Size: 26
		public const int CZ_REQ_USE_RAID_AUTO_SWEEP = 0x1002; // Size: 26
		public const int CZ_REQ_BRIDGE_WAILING = 0x1003; // Size: 26
		public const int CZ_REQUEST_CARD_PRESET = 0x1004; // Size: 26
		public const int ZC_RESPONSE_CARD_PRESET = 0x1005; // Size: 0
		public const int CZ_SET_CARD_PRESET = 0x1006; // Size: 0
		public const int CZ_SET_CARD_PRESET_TITLE = 0x1007; // Size: 90
		public const int ZC_TOSHERO_INFO = 0x1008; // Size: 58
		public const int ZC_TOSHERO_POINT_INFO = 0x1009; // Size: 14
		public const int ZC_TOSHERO_BUFFSHOP_INFO = 0x100A; // Size: 0
		public const int CZ_TOSHERO_BUY_BUFF = 0x100B; // Size: 26
		public const int CZ_TOSHERO_SELL_BUFF = 0x100C; // Size: 26
		public const int CZ_TOSHERO_SELECT_BUFF = 0x100D; // Size: 26
		public const int CZ_TOSHERO_UPGRADE_BUFF = 0x100E; // Size: 26
		public const int CZ_TOSHERO_DESELECT_BUFF = 0x100F; // Size: 22
		public const int CZ_TOSHERO_COMBINE_THREE_BUFF = 0x1010; // Size: 46
		public const int CZ_TOSHERO_CHANGE_ATTRIBUTE = 0x1011; // Size: 26
		public const int CZ_TOSHERO_RUN_LOTTERY = 0x1012; // Size: 26
		public const int CZ_TOSHERO_REINFORCE = 0x1013; // Size: 30
		public const int CZ_TOSHERO_CHANGE_EQUIP_OPTION = 0x1014; // Size: 34
		public const int CZ_TOSHERO_READY = 0x1015; // Size: 26
		public const int ZC_START_RANGE_PREVIEW = 0x1016; // Size: 151
		public const int ZC_END_RANGE_PREVIEW = 0x1017; // Size: 74
		public const int ZC_CLEAR_RANGE_PREVIEW = 0x1018; // Size: 10
		public const int ZC_FIX_DIRECTION = 0x1019; // Size: 78
		public const int ZC_FIX_DIRECTION_END = 0x101A; // Size: 14
		public const int CZ_REQ_TOGGLE_ABILITY = 0x101B; // Size: 26
		public const int ZC_MY_CHARACTER_LIST = 0x101C; // Size: 0
		public const int CZ_REG_CHANGE_CHARACTER_SLOT = 0x101D; // Size: 30
		public const int CZ_DEREG_CHANGE_CHARACTER_SLOT = 0x101E; // Size: 34
		public const int ZC_START_CHARACTER_CHANGE = 0x101F; // Size: 26
		public const int ZC_FINISH_CHARACTER_CHANGE = 0x1020; // Size: 30
		public const int CZ_REQ_CHARACTER_CHANGE = 0x1021; // Size: 34
		public const int ZC_CHARACTER_CHANGE_REGIST_COMPLETE = 0x1022; // Size: 22
		public const int ZC_CHARACTER_CHANGE_DEREGIST_COMPLETE = 0x1023; // Size: 14
		public const int ZC_MY_CHARACTER_DECK_LIST = 0x1024; // Size: 0
		public const int CZ_REQ_FAVORITE_INDUN_SET = 0x1025; // Size: 55
		public const int ZC_EQUIP_DUMMY_FOR_SKILL = 0x1026; // Size: 22
		public const int CZ_REQUEST_AETHER_GEM_REINFORCE = 0x1027; // Size: 38
		public const int ZC_SET_AURA_INFO = 0x1028; // Size: 279
		public const int CZ_OPEN_HELP = 0x1029; // Size: 86
		public const int CZ_REQ_UNKNOWN_SANTUARTY_BUFF = 0x102A; // Size: 346
		public const int ZC_SEND_CURRENT_JOIN_MGAME_NAME = 0x102B; // Size: 266
		public const int CZ_REQ_SUMMON_RIDE_PET = 0x102C; // Size: 26
		public const int CZ_REQ_SELECT_RIDE_PET = 0x102D; // Size: 26
		public const int CZ_ANS_GIVEUP_PREV_PLAYING_INDUN_PARTY = 0x102E; // Size: 23
		public const int CZ_LOCK_COLONY_ZONE_ENTER = 0x102F; // Size: 24
		public const int CZ_DICE = 0x1030; // Size: 27
		public const int ZC_SET_PLAYER_CONTENTS_RECORD_RESULT = 0x1031; // Size: 150
		public const int ZC_SEND_TEAM_BATTLE_LEAGUE_RESULT_LIST = 0x1032; // Size: 0
		public const int ZC_SEND_TEAM_BATTLE_LEAGUE_DETAIL_DAMAGE_LIST = 0x1033; // Size: 0
		public const int ZC_SEND_TEAM_BATTLE_LEAGUE_DETAIL_HEAL_LIST = 0x1034; // Size: 0
		public const int ZC_TEAM_BATTLE_LEAGUE_OBSERVE_RELEASE_LOCK_MOVE_KEY = 0x1035; // Size: 10
		public const int ZC_START_COMBO_INPUT_CMD = 0x1036; // Size: 0
		public const int ZC_END_COMBO_INPUT_CMD = 0x1037; // Size: 14
		public const int CZ_END_COMBO_INPUT = 0x1038; // Size: 27
		public const int ZC_START_ESCAPE_INPUT_CMD = 0x1039; // Size: 0
		public const int ZC_END_ESCAPE_INPUT_CMD = 0x103A; // Size: 14
		public const int CZ_CONTENTS_ALERT_MOVE = 0x103B; // Size: 22
		public const int ZC_TIMING_GAUGE_START = 0x103C; // Size: 54
		public const int ZC_TIMING_GAUGE_END = 0x103D; // Size: 15
		public const int ZC_CHARGING_GAUGE_START = 0x103E; // Size: 59
		public const int ZC_CHARGING_GAUGE_END = 0x103F; // Size: 15
		public const int ZC_INTERACTION_RIDE = 0x1040; // Size: 555
		public const int ZC_INTERACTION_COOL_TIME = 0x1041; // Size: 23
		public const int ZC_SQUAD_INFO = 0x1042; // Size: 0
		public const int CZ_INVITE_SQUAD_MEMBER = 0x1043; // Size: 91
		public const int ZC_INVITE_SQUAD_MEMBER = 0x1044; // Size: 217
		public const int CZ_RESPONSE_INVITED_SQUAD = 0x1045; // Size: 88
		public const int CZ_LEAVE_SQUAD = 0x1046; // Size: 95
		public const int CZ_CREATE_SQUAD = 0x1047; // Size: 91
		public const int CZ_DISBAND_SQUAD = 0x1048; // Size: 26
		public const int CZ_REQ_EARRING_RAID_PARTY_SKILL = 0x1049; // Size: 26
		public const int ZC_CUSTOM_CAMERA_ZOOM = 0x104A; // Size: 22
		public const int ZC_SHOW_SCENE_MODEL_LOCAL = 0x104B; // Size: 19
		public const int ZC_ADD_PAD_VISIBLE_OPTION = 0x104C; // Size: 16
		public const int ZC_REMOVE_PAD_VISIBLE_OPTION = 0x104D; // Size: 14
		public const int ZC_MGAME_USER_DAMAGE_LIST = 0x104E; // Size: 0
		public const int ZC_SEND_TRIBULATION_INFO = 0x104F; // Size: 0
		public const int CZ_REQ_TRIBULATION_INFO = 0x1050; // Size: 539
		public const int CZ_SEND_SELECTED_TRIBULATION_INFO = 0x1051; // Size: 0
		public const int ZC_SEND_SELECTED_TRIBULATION_INFO = 0x1052; // Size: 0
		public const int ZC_SEND_TRIBULATION_CLEAR = 0x1053; // Size: 282
		public const int CZ_SAVE_CLASS_SNAPSHOT = 0x1054; // Size: 52
		public const int CZ_RENAME_CLASS_SNAPSHOT = 0x1055; // Size: 50
		public const int CZ_UNEQUIP_ITEM_ALL = 0x1056; // Size: 22
		public const int CZ_APPLY_CLASS_SNAPSHOT = 0x1057; // Size: 26
		public const int CZ_REMOVE_CLASS_SNAPSHOT = 0x1058; // Size: 26
		public const int CZ_REQ_RUNSCRIPT = 0x1059; // Size: 22
		public const int CZ_REQ_TRANSLATE_MSG = 0x105A; // Size: 2107
		public const int ZC_SEND_TRANSLATED_MSG = 0x105B; // Size: 2111
		public const int ZC_SET_SOUND_MUTE = 0x105C; // Size: 16
		public const int ZC_SET_MUSIC_MUTE = 0x105D; // Size: 16
		public const int ZC_BREAK_SHIELD = 0x105E; // Size: 14
		public const int ZC_SHOW_MON_CASTING_UI = 0x105F; // Size: 538
		public const int CZ_REQ_RAID_GIVE_UP = 0x1060; // Size: 26
		public const int CZ_REQ_APPLY_HUD_SKIN = 0x1061; // Size: 26
		public const int CZ_REQ_CURRENT_HUD_SKIN = 0x1062; // Size: 23
		public const int ZC_SEND_MODE_HUD_SKIN = 0x1063; // Size: 15
		public const int ZC_SEND_APPLY_HUD_SKIN_MYSELF = 0x1064; // Size: 18
		public const int ZC_SEND_APPLY_HUD_SKIN_PARTY = 0x1065; // Size: 26
		public const int ZC_SEND_APPLY_HUD_SKIN_OTHER = 0x1066; // Size: 18
		public const int CZ_REQ_FIELD_BOSS_INDUN_REENTER_CHECK = 0x1067; // Size: 26
		public const int ZC_SEND_FIELD_BOSS_INDUN_REENTER_CHECK = 0x1068; // Size: 19
		public const int CZ_REQ_FULLSCREEN_MOVE_NPC = 0x1069; // Size: 2200
		public const int ZC_VERTIGO_GAMES_USER_BALANCE = 0x106A; // Size: 30
		public const int CZ_BUY_VERTIGO_GAMES_PRODUCT = 0x106B; // Size: 170
		public const int ZC_CHANGE_QUICKSLOT_INIT = 0x106C; // Size: 1046
		public const int CZ_REQ_QUICKSLOT_REFRESH = 0x106D; // Size: 22
		public const int ZC_SET_AURA_INTENSIVE_INFO = 0x106E; // Size: 18
		public const int ZC_UPDATE_SKL_SPDRATE_LIST = 0x106F; // Size: 0
		public const int ZC_CHARACTER_INDUN_INFO_RESPONSE = 0x1070; // Size: 0
		public const int ZC_ON_AFTER_IMAGE = 0x1071; // Size: 38
		public const int ZC_OFF_AFTER_IMAGE = 0x1072; // Size: 14
		public const int ZC_SEND_NONE_TARGETING_LIST = 0x1073; // Size: 0
		public const int ZC_UNITY_GROUND_EFFECT = 0x1074; // Size: 59
		public const int ZC_MON_LEADER_SHOW_ICON = 0x1075; // Size: 531
		public const int ZC_UPDATE_FAINT = 0x1076; // Size: 30
		public const int CZ_REQUEST_DIALOG_UI = 0x1077; // Size: 26
		...
		static Op()
		{
			...
			Sizes[ZC_ENTER_DUMMYPC] = 568;
			Sizes[ZC_UPDATED_DUMMYPC] = 526;
			...
			Sizes[ZC_UPDATED_PCAPPEARANCE] = 526;
