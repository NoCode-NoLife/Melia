...
namespace Melia.Shared.Network
{
	...
	public static class Op
	{
		...
		public const int CZ_WIKI_GET = 0xCF8; // Size: 14
		public const int CZ_WIKI_RECIPE_UPDATE = 0xCF9; // Size: 10
		public const int ZC_UI_OPEN = 0xCFA; // Size: 39
		public const int ZC_ENABLE_CONTROL = 0xCFB; // Size: 75
		public const int ZC_CHANGE_CAMERA = 0xCFC; // Size: 31
		public const int ZC_MONSTER_SDR_CHANGED = 0xCFD; // Size: 11
		public const int ZC_MOVE_IGNORE_COLLISION = 0xCFE; // Size: 30
		public const int ZC_CHANGE_CAMERA_ZOOM = 0xCFF; // Size: 34
		public const int ZC_PLAY_SKILL_ANI = 0xD00; // Size: 82
		public const int ZC_PLAY_SKILL_CAST_ANI = 0xD01; // Size: 30
		public const int CZ_REQ_ITEM_GET = 0xD02; // Size: 14
		public const int ZC_ITEM_GET = 0xD03; // Size: 18
		public const int CZ_GUARD = 0xD04; // Size: 19
		public const int ZC_GUARD = 0xD05; // Size: 19
		public const int ZC_STAMINA = 0xD06; // Size: 10
		public const int ZC_ADD_STAMINA = 0xD07; // Size: 10
		public const int ZC_GM_ORDER = 0xD08; // Size: 10
		public const int ZC_MYPC_ENTER = 0xD09; // Size: 18
		public const int ZC_LOCK_KEY = 0xD0A; // Size: 75
		public const int ZC_SAVE_INFO = 0xD0B; // Size: 6
		public const int CZ_SAVE_INFO = 0xD0C; // Size: 0
		public const int ZC_OPTION_LIST = 0xD0D; // Size: 0
		public const int ZC_SKILLMAP_LIST = 0xD0E; // Size: 0
		public const int CZ_GIVEITEM_TO_DUMMYPC = 0xD0F; // Size: 22
		public const int CZ_FOOD_TABLE_TITLE = 0xD10; // Size: 79
		public const int CZ_USE_TP_AND_ENTER_INDUN = 0xD11; // Size: 522
		public const int CZ_USE_RANKRESET_ITEM = 0xD12; // Size: 18
		public const int ZC_SET_LAYER = 0xD13; // Size: 10
		public const int ZC_CREATE_LAYERBOX = 0xD14; // Size: 38
		public const int ZC_RESET_BOX = 0xD15; // Size: 11
		public const int ZC_CREATE_SCROLLLOCKBOX = 0xD16; // Size: 38
		public const int ZC_REMOVE_SCROLLLOCKBOX = 0xD17; // Size: 10
		public const int CZ_DYNAMIC_CASTING_START = 0xD18; // Size: 25
		public const int CZ_DYNAMIC_CASTING_END = 0xD19; // Size: 20
		public const int CZ_SKILL_CANCEL_SCRIPT = 0xD1A; // Size: 10
		public const int ZC_LEAVE_TRIGGER = 0xD1B; // Size: 6
		public const int ZC_BORN = 0xD1C; // Size: 10
		public const int ZC_ACHIEVE_POINT_LIST = 0xD1D; // Size: 0
		public const int ZC_ACHIEVE_POINT = 0xD1E; // Size: 18
		public const int CZ_ACHIEVE_EQUIP = 0xD1F; // Size: 14
		public const int ZC_ACHIEVE_EQUIP = 0xD20; // Size: 22
		public const int CZ_ACHIEVE_REWARD = 0xD21; // Size: 14
		public const int CZ_CHANGE_CONFIG = 0xD22; // Size: 18
		public const int CZ_CHANGE_CONFIG_STR = 0xD23; // Size: 34
		public const int ZC_WORLD_MSG = 0xD24; // Size: 43
		public const int ZC_ENABLE_SHOW_ITEM_GET = 0xD25; // Size: 8
		public const int ZC_LOGIN_TIME = 0xD26; // Size: 14
		public const int ZC_GIVE_EXP_TO_PC = 0xD27; // Size: 42
		public const int ZC_LAYER_PC_LIST = 0xD28; // Size: 0
		public const int ZC_LAYER_PC_SOBJ_PROP = 0xD29; // Size: 0
		public const int CZ_CUSTOM_COMMAND = 0xD2A; // Size: 26
		public const int ZC_LAYER_INFO = 0xD2B; // Size: 10
		public const int CZ_CHAT_MACRO = 0xD2C; // Size: 146
		public const int ZC_CHAT_MACRO_LIST = 0xD2D; // Size: 0
		public const int ZC_RULLET_LIST = 0xD2E; // Size: 0
		public const int ZC_QUICKSLOT_REGISTER = 0xD2F; // Size: 46
		public const int CZ_QUICKSLOT_LIST = 0xD30; // Size: 0
		public const int CZ_DOUBLE_ITEM_EQUIP = 0xD31; // Size: 28
		public const int ZC_TRICK_PACKET = 0xD32; // Size: 0
		public const int ZC_COOLDOWN_RATE = 0xD33; // Size: 22
		public const int ZC_MAP_REVEAL_LIST = 0xD34; // Size: 0
		public const int CZ_MAP_REVEAL_INFO = 0xD35; // Size: 146
		public const int CZ_MAP_SEARCH_INFO = 0xD36; // Size: 55
		public const int ZC_EXEC_CLIENT_SCP = 0xD37; // Size: 0
		public const int ZC_SET_NPC_STATE = 0xD38; // Size: 18
		public const int ZC_NPC_STATE_LIST = 0xD39; // Size: 0
		public const int CZ_QUEST_NPC_STATE_CHECK = 0xD3A; // Size: 14
		public const int ZC_RANK_ACHIEVE_ADD = 0xD3B; // Size: 14
		public const int CZ_GET_MAP_REVEAL_ACHIEVE = 0xD3C; // Size: 10
		public const int CZ_IES_MODIFY_INFO = 0xD3D; // Size: 0
		public const int ZC_IES_MODIFY_INFO = 0xD3E; // Size: 0
		public const int ZC_IES_MODIFY_LIST = 0xD3F; // Size: 0
		public const int CZ_IES_REVISION_DELETE = 0xD40; // Size: 0
		public const int ZC_IES_REVISION_DELETE = 0xD41; // Size: 0
		public const int ZC_EQUIP_ITEM_REMOVE = 0xD42; // Size: 18
		public const int ZC_SOLD_ITEM_LIST = 0xD43; // Size: 0
		public const int ZC_SOLD_ITEM_DIVISION_LIST = 0xD44; // Size: 0
		public const int CZ_SOLD_ITEM = 0xD45; // Size: 19
		public const int CZ_WAREHOUSE_CMD = 0xD46; // Size: 32
		public const int CZ_SWAP_ETC_INV_CHANGE_INDEX = 0xD47; // Size: 35
		public const int CZ_SORT_INV = 0xD48; // Size: 12
		public const int CZ_EXTEND_WAREHOUSE = 0xD49; // Size: 11
		public const int CZ_CAST_CONTROL_SHOT = 0xD4A; // Size: 10
		public const int ZC_PC_PROP_UPDATE = 0xD4B; // Size: 11
		public const int CZ_CLIENT_DAMAGE = 0xD4C; // Size: 14
		public const int CZ_CLIENT_ATTACK = 0xD4D; // Size: 15
		public const int ZC_SYSTEM_MSG = 0xD4E; // Size: 0
		public const int ZC_FSM_MOVE = 0xD4F; // Size: 0
		public const int CZ_QUEST_CHECK_SAVE = 0xD50; // Size: 50
		public const int CZ_SPRAY_REQ_INFO = 0xD51; // Size: 14
		public const int CZ_SPRAY_DRAW_INFO = 0xD52; // Size: 0
		public const int ZC_SPRAY_ID = 0xD53; // Size: 18
		public const int ZC_SPRAY_DRAW_INFO = 0xD54; // Size: 0
		public const int ZC_MONSTER_LIFETIME = 0xD55; // Size: 14
		public const int ZC_SPRAY_LIKE_LIST = 0xD56; // Size: 0
		public const int ZC_WIKI_COUNT_UPDATE = 0xD57; // Size: 19
		public const int ZC_WIKI_INT_PROP_UPDATE = 0xD58; // Size: 15
		public const int ZC_WIKI_BOOL_PROP_UPDATE = 0xD59; // Size: 12
		public const int CZ_REQ_WIKI_RANK = 0xD5A; // Size: 15
		public const int ZC_WIKI_RANK_LIST = 0xD5B; // Size: 0
		public const int ZC_SHARED_MSG = 0xD5C; // Size: 10
		public const int CZ_REQ_WIKI_PROP_RANK = 0xD5D; // Size: 16
		public const int CZ_GET_WIKI_REWARD = 0xD5E; // Size: 11
		public const int CZ_REQ_TX_ITEM = 0xD5F; // Size: 0
		public const int ZC_TEST_DBG = 0xD60; // Size: 0
		public const int ZC_MONSTER_DIST = 0xD61; // Size: 0
		public const int ZC_RESET_SKILL_FORCEID = 0xD62; // Size: 10
		public const int ZC_EMOTICON = 0xD63; // Size: 18
		public const int ZC_SHOW_EMOTICON = 0xD64; // Size: 18
		public const int ZC_TREASUREMARK_BY_MAP = 0xD65; // Size: 0
		public const int ZC_SHOW_MAP = 0xD66; // Size: 0
		public const int CZ_FLEE_OBSTACLE = 0xD67; // Size: 26
		public const int ZC_HOLD_MOVE_PATH = 0xD68; // Size: 11
		public const int ZC_ENTER_HOOK = 0xD69; // Size: 10
		public const int ZC_LEAVE_HOOK = 0xD6A; // Size: 10
		public const int ZC_MONSTER_PROPERTY = 0xD6B; // Size: 0
		public const int ZC_GROUND_EFFECT = 0xD6C; // Size: 50
		public const int ZC_FLY = 0xD6D; // Size: 18
		public const int ZC_FLY_OPTION = 0xD6E; // Size: 14
		public const int ZC_FLY_MATH = 0xD6F; // Size: 23
		public const int ZC_FLY_HEIGHT = 0xD70; // Size: 14
		public const int ZC_UPDATE_SHIELD = 0xD71; // Size: 14
		public const int ZC_SHOW_MODEL = 0xD72; // Size: 15
		public const int ZC_SKILL_RANGE_DBG = 0xD73; // Size: 58
		public const int ZC_SKILL_RANGE_FAN = 0xD74; // Size: 40
		public const int ZC_SKILL_RANGE_SQUARE = 0xD75; // Size: 40
		public const int ZC_SKILL_RANGE_CIRCLE = 0xD76; // Size: 28
		public const int ZC_SKILL_RANGE_DONUTS = 0xD77; // Size: 32
		public const int ZC_TEAMID = 0xD78; // Size: 11
		public const int ZC_PC = 0xD79; // Size: 0
		public const int CZ_LOG = 0xD7A; // Size: 0
		public const int ZC_MOTIONBLUR = 0xD7B; // Size: 11
		public const int ZC_PLAY_FORCE = 0xD7C; // Size: 78
		public const int ZC_CAST_TARGET = 0xD7D; // Size: 14
		public const int ZC_START_INFO = 0xD7E; // Size: 0
		public const int ZC_JOB_EXP_UP = 0xD7F; // Size: 18
		public const int ZC_JOB_PTS = 0xD80; // Size: 18
		public const int ZC_MON_STAMINA = 0xD81; // Size: 22
		public const int CZ_CUSTOM_SCP = 0xD82; // Size: 14
		public const int ZC_VIEW_FOCUS = 0xD83; // Size: 24
		public const int ZC_HARDCODED_SKILL = 0xD84; // Size: 26
		public const int CZ_HARDCODED_SKILL = 0xD85; // Size: 34
		public const int ZC_FORCE_MOVE = 0xD86; // Size: 30
		public const int ZC_HSKILL_CONTROL = 0xD87; // Size: 22
		public const int ZC_CANCEL_DEADEVENT = 0xD88; // Size: 10
		public const int ZC_ACTION_PKS = 0xD89; // Size: 35
		public const int CZ_HARDCODED_ITEM = 0xD8A; // Size: 22
		public const int CZ_CANCEL_TRANSFORM_SKILL = 0xD8B; // Size: 10
		public const int CZ_BRIQUET = 0xD8C; // Size: 32
		public const int ZC_VIBRATE = 0xD8D; // Size: 30
		public const int ZC_COUNTER_MOVE = 0xD8E; // Size: 10
		public const int CZ_COUNTER_ATTACK = 0xD8F; // Size: 14
		public const int CZ_CLIENT_DIRECT = 0xD90; // Size: 30
		public const int ZC_CLIENT_DIRECT = 0xD91; // Size: 30
		public const int ZC_OWNER = 0xD92; // Size: 14
		public const int ZC_GD_RANK = 0xD93; // Size: 10
		public const int CZ_RUN_BGEVENT = 0xD94; // Size: 74
		public const int ZC_ADD_SKILL_EFFECT = 0xD95; // Size: 18
		public const int ZC_ITEM_DROPABLE = 0xD96; // Size: 10
		public const int CZ_ITEM_DROP_TO_OBJECT = 0xD97; // Size: 26
		public const int ZC_NORMAL = 0xD98; // Size: 0
		public const int CZ_G_QUEST_CHECK = 0xD99; // Size: 14
		public const int ZC_MOVE_PATH_MATH = 0xD9A; // Size: 30
		public const int CZ_MYPAGE_COMMENT_ADD = 0xD9B; // Size: 278
		public const int CZ_MYPAGE_COMMENT_DELETE = 0xD9C; // Size: 18
		public const int CZ_GUESTPAGE_COMMENT_ADD = 0xD9D; // Size: 278
		public const int CZ_GET_TARGET_MYPAGE = 0xD9E; // Size: 14
		public const int CZ_ON_MYPAGE_MODE = 0xD9F; // Size: 14
		public const int CZ_RESET_SOCIAL_MODE = 0xDA0; // Size: 10
		public const int CZ_GET_TARGET_GUESTPAGE = 0xDA1; // Size: 14
		public const int CZ_ADD_SELLMODE_ITEM = 0xDA2; // Size: 30
		public const int CZ_DELETE_SELLMODE_ITEM = 0xDA3; // Size: 18
		public const int CZ_ON_SELLITEM_MODE = 0xDA4; // Size: 14
		public const int ZC_MYPAGE_MAP = 0xDA5; // Size: 0
		public const int ZC_GUESTPAGE_MAP = 0xDA6; // Size: 0
		public const int ZC_ON_MYPAGE_MODE = 0xDA7; // Size: 0
		public const int ZC_RESET_SOCIAL_MODE = 0xDA8; // Size: 10
		public const int CZ_ON_ITEMBUY_MODE = 0xDA9; // Size: 0
		public const int ZC_ON_BUYITEM_MODE = 0xDAA; // Size: 0
		public const int ZC_SHOW_GROUND_ITEM_MARK = 0xDAB; // Size: 30
		public const int ZC_HELP_LIST = 0xDAC; // Size: 0
		public const int ZC_HELP_ADD = 0xDAD; // Size: 11
		public const int CZ_CLIENT_HIT_LIST = 0xDAE; // Size: 0
		public const int ZC_PC_ATKSTATE = 0xDAF; // Size: 11
		public const int ZC_SEND_PREMIUM_STATE = 0xDB0; // Size: 16
		public const int CZ_HELP_READ_TYPE = 0xDB1; // Size: 18
		public const int CZ_MOVE_PATH_END = 0xDB2; // Size: 10
		public const int ZC_COLL_DAMAGE = 0xDB3; // Size: 11
		public const int CZ_KEYBOARD_BEAT = 0xDB4; // Size: 10
		public const int CZ_MOVEHIT_SCP = 0xDB5; // Size: 22
		public const int ZC_SYNC_START = 0xDB6; // Size: 14
		public const int ZC_SYNC_END = 0xDB7; // Size: 14
		public const int ZC_SYNC_EXEC = 0xDB8; // Size: 10
		public const int ZC_SYNC_EXEC_BY_SKILL_TIME = 0xDB9; // Size: 18
		public const int CZ_STOP_TIMEACTION = 0xDBA; // Size: 11
		public const int CZ_REQ_DUMMYPC_INFO = 0xDBB; // Size: 18
		public const int CZ_VISIT_BARRACK = 0xDBC; // Size: 74
		public const int CZ_SPC_SKILL_POS = 0xDBD; // Size: 22
		public const int CZ_CHANGE_HEAD = 0xDBE; // Size: 74
		public const int CZ_CREATE_ARROW_CRAFT = 0xDBF; // Size: 14
		public const int CZ_REQ_MINITEXT = 0xDC0; // Size: 266
		public const int ZC_PC_MOVE_STOP = 0xDC1; // Size: 35
		public const int CZ_STOP_ALLPC = 0xDC2; // Size: 10
		public const int CZ_COMPLETE_PRELOAD = 0xDC3; // Size: 14
		public const int CZ_MGAME_JOIN_CMD = 0xDC4; // Size: 46
		public const int CZ_ADD_HELP = 0xDC5; // Size: 14
		public const int ZC_ATTACH_TO_OBJ = 0xDC6; // Size: 49
		public const int ZC_DETACH_FROM_OBJ = 0xDC7; // Size: 14
		public const int ZC_RUN_FROM = 0xDC8; // Size: 14
		public const int ZC_LOOKAT_OBJ = 0xDC9; // Size: 14
		public const int CZ_SKILL_CELL_LIST = 0xDCA; // Size: 0
		public const int CZ_SKILL_TOOL_GROUND_POS = 0xDCB; // Size: 26
		public const int CZ_DIRECTION_PROCESS = 0xDCC; // Size: 18
		public const int CZ_DIRECTION_MOVE_STATE = 0xDCD; // Size: 0
		public const int ZC_TO_ALL_CLIENT = 0xDCE; // Size: 0
		public const int ZC_TO_CLIENT = 0xDCF; // Size: 0
		public const int CZ_REWARD_CMD = 0xDD0; // Size: 14
		public const int CZ_PROPERTY_COMPARE = 0xDD1; // Size: 16
		public const int ZC_PROPERTY_COMPARE = 0xDD2; // Size: 0
		public const int ZC_PROPERTY_COMPARE_FOR_ACT = 0xDD3; // Size: 0
		public const int ZC_FACTION = 0xDD4; // Size: 14
		public const int ZC_SEND_CASH_VALUE = 0xDD5; // Size: 0
		public const int ZC_BEGIN_KILL_LOG = 0xDD6; // Size: 6
		public const int ZC_END_KILL_LOG = 0xDD7; // Size: 6
		public const int ZC_CLEAR_KILL_LOG = 0xDD8; // Size: 6
		public const int CZ_NPC_AUCTION_CMD = 0xDD9; // Size: 30
		public const int ZC_DIRECTION_APC = 0xDDA; // Size: 26
		public const int ZC_BGMODEL_ANIM_INFO = 0xDDB; // Size: 15
		public const int ZC_ATTACH_BY_KNOCKBACK = 0xDDC; // Size: 38
		public const int CZ_OBJECT_MOVE = 0xDDD; // Size: 30
		public const int CZ_CONTROL_OBJECT_ROTATE = 0xDDE; // Size: 22
		public const int CZ_SUMMON_COMMAND = 0xDDF; // Size: 18
		public const int CZ_VEHICLE_RIDE = 0xDE0; // Size: 15
		public const int CZ_REQ_WIKI_CATEGORY_RANK_PAGE_INFO = 0xDE1; // Size: 78
		public const int CZ_REQ_ACHIEVE_RANK_PAGE_INFO = 0xDE2; // Size: 78
		public const int CZ_REQ_MONSTER_RANK_INFO = 0xDE3; // Size: 74
		public const int ZC_SPC_TRIGGER_EXEC = 0xDE4; // Size: 30
		public const int CZ_REQ_MGAME_VIEW = 0xDE5; // Size: 18
		public const int CZ_REQ_MGAME_CHAT = 0xDE6; // Size: 0
		public const int CZ_TOURNAMENT_GIFT = 0xDE7; // Size: 18
		public const int CZ_PARTY_INVITE_ACCEPT = 0xDE8; // Size: 87
		public const int CZ_PARTY_INVITE_CANCEL = 0xDE9; // Size: 91
		public const int CZ_PARTY_PROP_CHANGE = 0xDEA; // Size: 147
		public const int CZ_REQ_MARKET_REGISTER = 0xDEB; // Size: 40
		public const int CZ_REQ_MARKET_MINMAX_INFO = 0xDEC; // Size: 18
		public const int CZ_REQ_MARKET_BUY = 0xDED; // Size: 0
		public const int CZ_REQ_MARKET_LIST = 0xDEE; // Size: 138
		public const int CZ_REQ_MY_SELL_LIST = 0xDEF; // Size: 14
		public const int CZ_REQ_CABINET_LIST = 0xDF0; // Size: 10
		public const int CZ_REQ_GET_CABINET_ITEM = 0xDF1; // Size: 26
		public const int CZ_REQ_CANCEL_MARKET_ITEM = 0xDF2; // Size: 18
		public const int CZ_INV_ITEM_LOCK = 0xDF3; // Size: 19
		public const int CZ_OBJ_RECORD_POS = 0xDF4; // Size: 0
		public const int CZ_FORMATION_CMD = 0xDF5; // Size: 32
		public const int CZ_REGISTER_AUTOSELLER = 0xDF6; // Size: 0
		public const int CZ_OPEN_AUTOSELLER = 0xDF7; // Size: 66
		public const int CZ_BUY_AUTOSELLER_ITEMS = 0xDF8; // Size: 0
		public const int CZ_SELL_MY_AUTOSELLER_ITEMS = 0xDF9; // Size: 0
		public const int CZ_PUZZLE_CRAFT = 0xDFA; // Size: 0
		public const int CZ_PET_EQUIP = 0xDFB; // Size: 34
		public const int CZ_PET_AUTO_ATK = 0xDFC; // Size: 11
		public const int ZC_PET_AUTO_ATK = 0xDFD; // Size: 11
		public const int ZC_FOUND_PARTY_LIST = 0xDFE; // Size: 0
		public const int ZC_NEAR_PARTY_LIST = 0xDFF; // Size: 0
		public const int ZC_RECOMMEND_PARTY_INFO = 0xE00; // Size: 0
		public const int CZ_REQUEST_SOME_PARTY = 0xE01; // Size: 90
		public const int CZ_REFRESH_MEMBERRECOMMEND_LIST = 0xE02; // Size: 10
		public const int ZC_TO_SOMEWHERE_CLIENT = 0xE03; // Size: 0
		public const int CZ_REVEAL_NPC_STATE = 0xE04; // Size: 14
		public const int CZ_CHANGE_CHANNEL = 0xE05; // Size: 12
		public const int CZ_REQ_CHANNEL_TRAFFICS = 0xE06; // Size: 12
		public const int CZ_BUY_PROPERTYSHOP_ITEM = 0xE07; // Size: 0
		public const int CZ_SKILL_USE_HEIGHT = 0xE08; // Size: 14
		public const int CZ_ACCEPT_PARTY_QUEST = 0xE09; // Size: 20
		public const int CZ_CHANGE_GUILD_NEUTRALITY = 0xE0A; // Size: 10
		public const int CZ_SAVE_GUILD_BOARD = 0xE0B; // Size: 110
		public const int CZ_ACCEPT_PARTY_EVENT = 0xE0C; // Size: 20
		public const int CZ_DELETE_PARTY_EVENT = 0xE0D; // Size: 20
		public const int CZ_PING = 0xE0E; // Size: 10
		public const int ZC_PING = 0xE0F; // Size: 10
		public const int CZ_REQ_REMAIN_NEXONCASH = 0xE10; // Size: 10
		public const int CZ_REQ_OPEN_INGAMESHOP_UI = 0xE11; // Size: 10
		public const int CZ_REQ_BUY_INGAMESHOP_ITEM = 0xE12; // Size: 78
		public const int CZ_REQ_BUY_ALL_INGAMESHOP_ITEM = 0xE13; // Size: 10
		public const int CZ_REQ_PICKUP_CASHITEM = 0xE14; // Size: 37
		public const int CZ_REQ_REFUND_CASHITEM = 0xE15; // Size: 33
		public const int ZC_XIGNCODE_BUFFER = 0xE16; // Size: 524
		public const int CZ_XIGNCODE_BUFFER = 0xE17; // Size: 524
		public const int CZ_SYSTEM_LOG_SAVE_TO_MONGODB = 0xE18; // Size: 280
		public const int CZ_CHANGE_TITLE = 0xE19; // Size: 74
		public const int CZ_PC_COMMENT_CHANGE = 0xE1A; // Size: 0
		public const int CZ_AUTTOSELLER_BUYER_CLOSE = 0xE1B; // Size: 18
		public const int CZ_REQ_ITEM_LIST = 0xE1C; // Size: 11
		public const int CZ_REQ_ACC_WARE_VIS_LOG = 0xE1D; // Size: 10
		public const int CZ_HIT_MISSILE = 0xE1E; // Size: 14
		public const int CZ_I_NEED_PARTY = 0xE1F; // Size: 23
		public const int CZ_PARTY_JOIN_BY_LINK = 0xE20; // Size: 19
		public const int ZC_RECOMMEND_PARTYMEMBER_INFO = 0xE21; // Size: 0
		public const int CZ_PVP_ZONE_CMD = 0xE22; // Size: 26
		public const int CZ_PVP_CHAT = 0xE23; // Size: 0
		public const int CZ_CARDBATTLE_CMD = 0xE24; // Size: 26
		public const int CZ_REQ_UPDATE_CONTENTS_SESSION = 0xE25; // Size: 10
		public const int CZ_REQ_FRIENDLY_FIGHT = 0xE26; // Size: 15
		public const int CZ_HARDSKILL_POS_LIST = 0xE27; // Size: 0
		public const int CZ_CART_POSITION = 0xE28; // Size: 26
		public const int CZ_REQ_RIDE_CART = 0xE29; // Size: 18
		public const int CZ_DUMMYPC_SKILL_POS = 0xE2A; // Size: 26
		public const int CZ_NGS = 0xE2B; // Size: 0
		public const int CZ_PARTY_MEMBER_SKILL_USE = 0xE2C; // Size: 0
		public const int CZ_PARTY_MEMBER_SKILL_ACCEPT = 0xE2D; // Size: 22
		public const int CZ_SYSTEM_LOG_TO_SERVER = 0xE2E; // Size: 1099
		public const int CZ_CHECK_PING = 0xE2F; // Size: 10
		public const int CZ_CANCEL_INDUN_MATCHING = 0xE30; // Size: 10
		public const int CZ_CANCEL_INDUN_PARTY_MATCHING = 0xE31; // Size: 10
		public const int CZ_REQ_GM_ORDER = 0xE32; // Size: 202
		public const int CZ_REPORT_AUTOBOT = 0xE33; // Size: 74
		public const int CZ_REPORT_PVP_ZOOM = 0xE34; // Size: 10
		public const int CZ_PARTY_INVENTORY_LOAD = 0xE35; // Size: 12
		public const int CZ_PARTY_SHARED_QUEST = 0xE36; // Size: 278
		public const int CZ_REQ_MOVE_PARTYINV_TO_ACCOUNT = 0xE37; // Size: 31
		public const int CZ_PVP_COMMAND = 0xE38; // Size: 23
		public const int CZ_REQ_CancelGachaCube = 0xE39; // Size: 10
		public const int CZ_WAREHOUSE_TAKE_LIST = 0xE3A; // Size: 0
		public const int CZ_SAVE_AUTO_MACRO = 0xE3B; // Size: 0
		public const int CZ_REQUEST_LOAD_ITEM_BUY_LIMIT = 0xE3C; // Size: 10
		public const int CZ_AUTO_STATE = 0xE3D; // Size: 11
		public const int CZ_RUN_GAMEEXIT_TIMER = 0xE3E; // Size: 42
		public const int CZ_FIXED_NOTICE_SHOW = 0xE3F; // Size: 10
		public const int CZ_SAGE_SKILL_GO_FRIEND = 0xE40; // Size: 90
		public const int CZ_REQUEST_CHANGE_NAME = 0xE41; // Size: 66
		public const int ZC_HOLD_EXP_BOOK_TIME = 0xE43; // Size: 25
		public const int CZ_HOLD_EXP_BOOK_TIME = 0xE44; // Size: 14
		public const int CZ_SCREENSHOT_HASH = 0xE45; // Size: 43
		public const int CZ_REQ_MOVE_TO_INDUN = 0xE46; // Size: 18
		public const int CZ_CLEAR_INDUN_REG = 0xE47; // Size: 10
		public const int CZ_REQ_REGISTER_TO_INDUN = 0xE48; // Size: 14
		public const int CZ_REQ_GUILD_MEMBER_AUTHORITY = 0xE49; // Size: 23
		public const int CZ_TPSHOP_RTPP_FOR_TEST = 0xE4A; // Size: 10
		public const int CZ_REQ_FORGERY = 0xE4B; // Size: 30
		public const int CZ_REQ_BUILD_FOODTABLE = 0xE4C; // Size: 79
		public const int CZ_REQ_UNDERSTAFF_ENTER_ALLOW = 0xE4D; // Size: 10
		public const int CZ_REQ_UNDERSTAFF_ENTER_ALLOW_WITH_PARTY = 0xE4E; // Size: 14
