<script setup>
import NavLink from '@/components/HomeNavLink.vue'
</script>
...
<template>
  <footer class="max-w-screen-xl px-8 mx-auto">
    <div class="w-full border-y border-[#DDDDDD]">
      ...
      >
        ...
        >
          ...
          <ul class="space-y-4">
            <NavLink name="Home" :url="route('home')" />
            <NavLink name="Login" :url="route('login')" />
            <NavLink
              name="Github"
              newPage
              url="https://github.com/NoCode-NoLife/melia"
            />
          </ul>
        </div>
        <div
        ...
        >
          <ul class="space-y-4">
            <NavLink name="PrivacyPolicy" url="#" />
            <NavLink name="PrivacyPolicy" url="#" />
            <NavLink name="PrivacyPolicy" url="#" />
          </ul>
        </div>
        ...
        >
          <ul class="space-y-4">
            <NavLink
              name="Wiki"
              newPage
              url="https://github.com/NoCode-NoLife/melia/wiki"
            />
            <NavLink name="Contact Us" url="#" />
            <NavLink name="Admin Dashboard" :url="route('admin.dashboard')" />
          </ul>
        </div>
        <div
    ...
    >
      &copy; Copyright 2023 Melia. All rights reserved
    </div>
  </footer>
</template>
<script>
