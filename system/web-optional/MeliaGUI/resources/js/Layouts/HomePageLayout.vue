...
<template>
  <div class="min-h-screen font-sans antialiased relative">
    <div class="relative">
      <div
        class="absolute top-0 left-0 w-full h-[55vh] sm:h-[225vh] lg:h-[55vh] cover-gradient-2 sm:cover-gradient"
      ></div>
      <BaseNavbar />
...
.bg-blue-gradient,
.text-gradient {
  background: linear-gradient(136.91deg, #122541 -12.5%, #285292 107.5%);
}
.text-gradient {
