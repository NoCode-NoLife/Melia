...
public class FRokas31MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner(MonsterId.Warleader_Hogma, 5, TimeSpan.FromMilliseconds(0), "Spawner1.f_rokas_31");
		AddSpawner(MonsterId.Rootcrystal_03, 4, TimeSpan.FromMilliseconds(5000), "Spawner2.f_rokas_31");
		AddSpawner(MonsterId.Tontulia, 15, TimeSpan.FromMilliseconds(0), "Spawner3.f_rokas_31");
		AddSpawner(MonsterId.Warleader_Hogma, 3, TimeSpan.FromMilliseconds(0), "Spawner4.f_rokas_31");
		AddSpawner(MonsterId.Repusbunny_Mage, 5, TimeSpan.FromMilliseconds(0), "Spawner5.f_rokas_31");
