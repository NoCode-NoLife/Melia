...
public class CHighlanderMobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("c_highlander.Id1", MonsterId.Wood_Carving_Fire, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("c_highlander.Id2", MonsterId.Wood_Carving_Poison, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("c_highlander.Id3", MonsterId.Wood_Carving_Lightning, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("c_highlander.Id4", MonsterId.Wood_Carving_Earth, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
