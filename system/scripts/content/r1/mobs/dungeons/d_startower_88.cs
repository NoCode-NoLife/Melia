...
public class DStartower88MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("d_startower_88.Id1", MonsterId.NightPanto_Stellar, 12, 15);
		AddSpawner("d_startower_88.Id2", MonsterId.NightPanto_Archer, 17, 22);
		AddSpawner("d_startower_88.Id3", MonsterId.NightPanto_Mage, 9, 11);
		AddSpawner("d_startower_88.Id4", MonsterId.NightPanto_Mage, 8, 10);
		AddSpawner("d_startower_88.Id5", MonsterId.Mushuta, 30, 39);
