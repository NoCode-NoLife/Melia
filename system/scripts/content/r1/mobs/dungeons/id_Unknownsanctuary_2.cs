...
public class IdUnknownsanctuary2MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("id_Unknownsanctuary_2.Id1", MonsterId.FD_Boss_Froster_Lord, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(15000), tendency: TendencyType.Aggressive);
		AddSpawner("id_Unknownsanctuary_2.Id2", MonsterId.FD_Boss_Kucarry_Balzermancer, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(15000), tendency: TendencyType.Aggressive);
		AddSpawner("id_Unknownsanctuary_2.Id3", MonsterId.FD_Boss_Wastrel, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(15000), tendency: TendencyType.Aggressive);
		AddSpawner("id_Unknownsanctuary_2.Id4", MonsterId.FD_Boss_Ignas, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(15000), tendency: TendencyType.Aggressive);
		AddSpawner("id_Unknownsanctuary_2.Id5", MonsterId.FD_Boss_Asiomage, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(15000), tendency: TendencyType.Aggressive);
		AddSpawner("id_Unknownsanctuary_2.Id6", MonsterId.FD_Boss_Skiaclipse, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(15000), tendency: TendencyType.Aggressive);
		AddSpawner("id_Unknownsanctuary_2.Id7", MonsterId.FD_Boss_Moringponia, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(15000), tendency: TendencyType.Aggressive);
		AddSpawner("id_Unknownsanctuary_2.Id8", MonsterId.FD_Boss_Tantaliser, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(15000), tendency: TendencyType.Aggressive);
		AddSpawner("id_Unknownsanctuary_2.Id9", MonsterId.FD_Boss_Pbeta, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(15000), tendency: TendencyType.Aggressive);
		AddSpawner("id_Unknownsanctuary_2.Id10", MonsterId.FD_Boss_Glacier, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(15000), tendency: TendencyType.Aggressive);
		AddSpawner("id_Unknownsanctuary_2.Id11", MonsterId.FD_Boss_Velcoffer, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(15000), tendency: TendencyType.Aggressive);
		AddSpawner("id_Unknownsanctuary_2.Id12", MonsterId.FD_Boss_Skiaclipse, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(15000), tendency: TendencyType.Aggressive);
		AddSpawner("id_Unknownsanctuary_2.Id13", MonsterId.FD_Boss_Skiaclipse, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(15000), tendency: TendencyType.Aggressive);
