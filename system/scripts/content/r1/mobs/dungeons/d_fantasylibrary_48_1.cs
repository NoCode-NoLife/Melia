...
public class DFantasylibrary481MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("d_fantasylibrary_48_1.Id2", MonsterId.Page_Mimic, 68, 90);
		AddSpawner("d_fantasylibrary_48_1.Id3", MonsterId.Bookmark_Mimic, 30, 40);
		AddSpawner("d_fantasylibrary_48_1.Id4", MonsterId.Oscuro, 14, 18);
		AddSpawner("d_fantasylibrary_48_1.Id5", MonsterId.Claro, 30, 40);
		AddSpawner("d_fantasylibrary_48_1.Id6", MonsterId.Oscuro, 17, 22);
