...
public class FNicopolis812MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("f_nicopolis_81_2.Id1", MonsterId.Wiza_Moya, 37, 49);
		AddSpawner("f_nicopolis_81_2.Id2", MonsterId.Mimorat_Pink, 25, 33);
		AddSpawner("f_nicopolis_81_2.Id3", MonsterId.Mimorat_White, 30, 39);
		AddSpawner("f_nicopolis_81_2.Id4", MonsterId.Vine_Walker, 11, 14);
