...
public class FPilgrimroad47MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("f_pilgrimroad_47.Id1", MonsterId.Triffid, 8, 10);
		AddSpawner("f_pilgrimroad_47.Id2", MonsterId.Rondo_Red, 23, 30);
		AddSpawner("f_pilgrimroad_47.Id3", MonsterId.Rubabos_Red, 3, 4);
		AddSpawner("f_pilgrimroad_47.Id4", MonsterId.Rondo_Red, 8, 10);
		AddSpawner("f_pilgrimroad_47.Id5", MonsterId.Rootcrystal_01, 4, 5, TimeSpan.FromMilliseconds(5000));
		AddSpawner("f_pilgrimroad_47.Id6", MonsterId.Spell_Crystal_Red, 9, 11);
		AddSpawner("f_pilgrimroad_47.Id7", MonsterId.Triffid, 60, 80);
