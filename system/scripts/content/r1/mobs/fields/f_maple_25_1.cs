...
public class FMaple251MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("f_maple_25_1.Id1", MonsterId.Rodenarcorng, 27, 35, TimeSpan.FromMilliseconds(0));
		AddSpawner("f_maple_25_1.Id2", MonsterId.Rodenag, 15, 20, TimeSpan.FromMilliseconds(0));
		AddSpawner("f_maple_25_1.Id3", MonsterId.Rodetad, 23, 30, TimeSpan.FromMilliseconds(0));
		AddSpawner("f_maple_25_1.Id4", MonsterId.Rodenarcorng, 23, 30, TimeSpan.FromMilliseconds(0));
