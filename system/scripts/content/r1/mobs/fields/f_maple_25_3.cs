...
public class FMaple253MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("f_maple_25_3.Id1", MonsterId.Nacorngfly, 42, 55, TimeSpan.FromMilliseconds(0));
		AddSpawner("f_maple_25_3.Id2", MonsterId.Nacorngbug, 23, 30, TimeSpan.FromMilliseconds(0));
		AddSpawner("f_maple_25_3.Id3", MonsterId.Rodeyokel, 27, 35, TimeSpan.FromMilliseconds(0));
		AddSpawner("f_maple_25_3.Id4", MonsterId.Nacorngbug, 27, 35, TimeSpan.FromMilliseconds(0));
		AddSpawner("f_maple_25_3.Id5", MonsterId.Rodevassal, 1, 1, TimeSpan.FromMilliseconds(1800000));
		AddSpawner("f_maple_25_3.Id6", MonsterId.Rootcrystal_05, 19, 25, TimeSpan.FromMilliseconds(30000));
