...
public class FFlash58MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("f_flash_58.Id2", MonsterId.Infroholder_Red, 45, 60);
		AddSpawner("f_flash_58.Id3", MonsterId.Socket_Purple, 23, 30);
		AddSpawner("f_flash_58.Id4", MonsterId.Infroholder_Mage_Green, 12, 15);
