...
public class FPilgrimroad414MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("f_pilgrimroad_41_4.Id2", MonsterId.Dumaro_Yellow, 9, 12);
		AddSpawner("f_pilgrimroad_41_4.Id3", MonsterId.Repusbunny_Purple, 60, 80);
		AddSpawner("f_pilgrimroad_41_4.Id4", MonsterId.Repusbunny_Bow_Purple, 9, 12);
