...
public class FKatyn13MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("f_katyn_13.Id2", MonsterId.HighBube_Spear, 15, 20);
		AddSpawner("f_katyn_13.Id3", MonsterId.HighBube_Archer, 15, 20);
		AddSpawner("f_katyn_13.Id4", MonsterId.Arburn_Pokubu_Green, 30, 40);
		AddSpawner("f_katyn_13.Id5", MonsterId.HighBube_Spear, 15, 20);
		AddSpawner("f_katyn_13.Id6", MonsterId.HighBube_Archer, 8, 10);
		AddSpawner("f_katyn_13.Id7", MonsterId.Arburn_Pokubu_Green, 12, 15);
