...
public class FCastle204MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("f_castle_20_4.Id2", MonsterId.Shardstatue_Black, 15, 20);
		AddSpawner("f_castle_20_4.Id3", MonsterId.Templeslave_Black, 15, 20);
		AddSpawner("f_castle_20_4.Id4", MonsterId.Templeslave_Sword_Black, 15, 20);
		AddSpawner("f_castle_20_4.Id5", MonsterId.Templeslave_Sword_Black, 19, 25);
