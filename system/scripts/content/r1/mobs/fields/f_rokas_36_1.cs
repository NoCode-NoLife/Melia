...
public class FRokas361MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("f_rokas_36_1.Id2", MonsterId.Sec_Chupacabra_Desert, 15, 20, TimeSpan.FromMilliseconds(0));
		AddSpawner("f_rokas_36_1.Id3", MonsterId.GlyphRing, 23, 30, TimeSpan.FromMilliseconds(0));
		AddSpawner("f_rokas_36_1.Id4", MonsterId.Sec_Sauga, 23, 30, TimeSpan.FromMilliseconds(0));
		AddSpawner("f_rokas_36_1.Id5", MonsterId.Sec_Chupacabra_Desert, 15, 20, TimeSpan.FromMilliseconds(0));
		AddSpawner("f_rokas_36_1.Id6", MonsterId.Sec_Sauga, 12, 15, TimeSpan.FromMilliseconds(0));
		AddSpawner("f_rokas_36_1.Id7", MonsterId.GlyphRing, 12, 15, TimeSpan.FromMilliseconds(0));
