...
public class FDcapital106MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("f_dcapital_106.Id2", MonsterId.Wajak_Walker, 24, 31);
		AddSpawner("f_dcapital_106.Id3", MonsterId.Horong_Walker, 23, 30);
		AddSpawner("f_dcapital_106.Id4", MonsterId.Bishop_Hart, 8, 10);
		AddSpawner("f_dcapital_106.Id5", MonsterId.Bishop_Point, 27, 36);
