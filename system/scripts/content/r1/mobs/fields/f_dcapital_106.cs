...
public class FDcapital106MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("f_dcapital_106.Id1", MonsterId.Rootcrystal_01, min: 27, max: 35, respawn: TimeSpan.FromMilliseconds(25000));
		...
		AddSpawner("f_dcapital_106.Id6", MonsterId.Bishop_Point, min: 3, max: 4, respawn: TimeSpan.FromMilliseconds(10000));
