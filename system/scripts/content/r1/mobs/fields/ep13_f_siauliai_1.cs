...
public class Ep13FSiauliai1MobScript : GeneralScript
{
	public override void Load()
	{
		...
		AddSpawner("ep13_f_siauliai_1.Id5", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id6", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id7", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id8", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id9", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id10", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id11", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id12", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id13", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id14", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id15", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id16", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id17", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id18", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id19", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id20", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id21", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id22", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id23", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id24", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id25", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id26", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id27", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id28", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id29", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id30", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id31", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id32", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id33", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id34", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id35", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id36", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id37", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id38", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id39", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id40", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id41", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id42", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id43", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id44", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id45", MonsterId.Liepsna_Invader, min: 15, max: 20, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id46", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id47", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
		AddSpawner("ep13_f_siauliai_1.Id48", MonsterId.Liepsna_Spreader, min: 1, max: 1, respawn: TimeSpan.FromMilliseconds(60000));
